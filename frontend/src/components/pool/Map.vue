...
<template>
  <a :href="`https://osu.ppy.sh/b/${map.map_id}`" class="map-container">
    <img :src="`https://assets.ppy.sh/beatmaps/${map.set_id}/covers/cover@2x.jpg`"
      class="absolute h-full w-full object-cover inset-0 -z-10" />
